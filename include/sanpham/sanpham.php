<?php
	...
	$ma=$_POST['MaLH'];
		...
		$strSQLH="SELECT * FROM loai_cay WHERE ma_loai={$ma}";
	...
	//////////////////////////////////////////////////////////
	$strSQL="SELECT count(*) FROM cay {$dieukien} ;";
	...
	$strSQL="SELECT * FROM cay {$dieukien} ORDER BY ma_cay desc Limit {$dongbatdau},{$kichthuoctrang}";
	$qua=mysqli_query($ung,$strSQL);
?>
							...
							<table width="437" cellpadding="0" cellspacing="0" border="0">
								<tr> 
									<td height="20" align="center">
										...
										Tên Sản Phẩm:</span> 								
										<span class="ten">
										<a href="#" onclick="chitiet('<?php echo $row['ma_cay']; ?>')"><b><?php echo $row									                                         ['ten_cay']; ?></b></a>
										</span>
