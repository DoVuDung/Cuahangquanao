...
<div class="spm">
	<h3>Sản phẩm mới</h3>
				...
				<?php
					$strSQL="SELECT * FROM cay ORDER BY ma_cay desc";
...
<div class="product">
	        <div class="image">
				<a href="#" onclick="chitiet('<?php echo $row['ma_cay']; ?>')">
				    <img src="images/sp/<?php echo $row['hinh_anh']; ?>" border="0" height="103" width="120" />
				</a>
			</div>
			<div class="item">
				<div class="name_pd">Tên sản phẩm : <span class="ten"><a href="#" onclick="chitiet('<?php echo $row['ma_cay']; ?>')"><b><?php echo $row['ten_cay']; ?></b></a>												<?php
				...
				<div class="name_pd">Giá bán:<span class="ten"><a href="#" onclick="chitiet('<?php echo $row['ma_cay']; ?>')"><b><?php echo number_format($row['gia'],0,'.','.'); ?> VNĐ</b></a></span>
				</div>
				<div class="name_pd">Số lượng:<span class="ten"><a href="#" onclick="chitiet('<?php echo $row['ma_cay']; ?>')"><b><?php echo number_format($row['so_luong'],0); ?> Chiếc</b></a></span>
				</div>
				<div class="detail">
					<a href="#" onclick="chitiet('<?php echo $row['ma_cay']; ?>')">Chi Tiết </a>
					<img src="images/icon.png" border="0" width="14" height="14" align="bottom" />
					<a href="#" onclick="chonhang('<?php echo $row['ma_cay']; ?>','<?php echo $row['ten_cay']; ?>','<?php echo $row['gia']; ?>')">Đặt Mua</a>
				</div>									
