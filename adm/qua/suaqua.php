<?php 
	...
	$strSQL="SELECT * FROM cay WHERE ma_cay={$maqua}";
 ...
 <table width="750" height="132" border="0" cellpadding="2" cellspacing="0" class="admintable" style="border-right:#E9E9E9 1px solid; border-top:#E9E9E9 1px solid;" align="right">
	...
	<tr>
      <td colspan="2" align="left">
	  		&nbsp;&nbsp;Tên Quần Áo:
        		<input name="tenqua" type="text" id="tenqua" maxlength="30" style="width:180px;" value="<?php echo $rowsua['ten_cay']; ?>" />
        	&nbsp;&nbsp;Loại Quần Áo:
		<select name="loaiqua">
			<?php 
    ...
    <tr>
      <td colspan="2" align="center">
		...
		<input name="maqua" type="hidden" value="<?php echo $rowsua['ma_cay']; ?>" />
